...
public class SyncController implements Initializable {
    ...
    @FXML
    private Button previousKillButton;
    @FXML
    private Button nextKillButton;
    @FXML
    ...
    @FXML
    private Button previousSyncTargetButton;
    @FXML
    private Button nextSyncTargetButton;
    @FXML
    private Button syncButton;
    @FXML
    private Label syncTargetLabel;
...
//</editor-fold>
    ...
    private void initializeMediaPlayer() {
        ...
        mediaPlayer.currentTimeProperty().addListener((observable, oldValue, newValue) -> {
            if (!clickedOnScrubber) {
                scrubber.setValue(newValue.toSeconds());
            }
        });
